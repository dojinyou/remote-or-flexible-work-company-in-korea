...
- **회사 소개**
    불합리하고 불신 가득한 통신 시장 문제를 우리 같이 해결해요!
    가장 빠르게 성장할 훌륭한 동료들이 기다리고 있을게요.

    모요는 런칭 10개월 만에 이용자 80만 명을 돌파하고,
    카카오벤처스와 베이스인베스트먼트에게 시드 투자를 유치하며
    누구보다 빠르게 성장하고 있는 스타트업이에요.

    빠르게 성장하고 통신 시장의 혁신을 일으킬 동료들을 기다립니다!
    
- **업무 방식**
    - 업무 시간을 정해놓지 않아요. 각자 집중이 잘 되는 시간에 업무에 임하면 돼요.
    - 업무 장소도 구애받지 않아요. 집에서 하는 업무가 집중이 잘 된다면 집에서 업무에 집중해요.
    
- **휴가 및 건강**
    - 무제한 휴가를 제공해요.
    - 리프레시 휴가를 지원해요. 3년 만근 시, 1개월 유급휴가입니다.
    - 건강 검진을 지원해요.
...
- 최고사양 장비 지급(맥북, 4K 모니터를 비롯한 원하는 장비 지급)
- 영어 닉네임 사용을 통한 수평적 문화
- 자율복장
- 무제한 간식, 조식
- 근속년수에 따른 리프레시 휴가
- 1 on 1 멘토링을 통한 Soft Landing 지원
- 업계 최고 수준의 연봉
- 경조사 지원
- 기념일, 명절 선물 지급
